...
class SIOCaptchaHandler(BaseCaptcha):
    """
    ...
    def get_sync_result(self, url_response: str = GET_RESULT_POSTFIX) -> dict:
        ...
        for _ in attempts:
            captcha_response = GetTaskResultResponseSer(
                **self._session.post(
                ...
                taskId=self._get_result_params.taskId,
            )
